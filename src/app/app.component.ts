...
export class MyApp {
  ...
  initPages() {
    this.pages = [
      ...
      { title: '商城', component: 'LoginPage', icon: 'ios-cart-outline' },
      { title: '听歌识别', component: 'LoginPage', icon: 'ios-mic-outline' },
      { title: '定时停止播放', component: 'LoginPage', icon: 'ios-clock-outline' },
